...
def write(path, records, years, rows_filter, sort_key, career_year):
    ...
    with path.open('w', newline='', encoding='utf-8') as handle:
        ...
        writer.writerow([
            ...
            'Contribution_review_status', 'Contribution_review_reason',
        ...
        for record in rows:
            ...
            writer.writerow([
                ...
                record.get('contribution_status', 'not yet curated'),
                record.get('profile', {}).get('contribution_review', {}).get('status', 'not recorded'),
                record.get('profile', {}).get('contribution_review', {}).get('reason', ''),
                record.get('active_years_in_window'),
